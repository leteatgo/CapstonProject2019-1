...
// added by janar153 @ 29.12.2013
    ...
    public void init(Session s){
        ...
        peopleread = new SerializerRead() { /*  DB 에서 peopleread 방식으로 읽어 온다면 AppUser 클래스에 이러한 형식으로 담는다 */
            @Override
...
//*******************************************************************        
 ...
 //******************************************************************      
        ...
        m_peoplevisible = new StaticSentence(s
            ...
            , null
            , peopleread);
        // public StaticSentence(Session s, String sentence, SerializerWrite serwrite, SerializerRead serread) 마지막 인자 peopleread는 읽어온 정보를 어떠한 형식으로 Serialize할지 정의한다
