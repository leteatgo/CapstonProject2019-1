...
// JG 6 May 2013 use multicatch
    ...
    private void assignMenuButtonIcon() {   /*  메뉴 열기, 닫기 버튼    */
...
//        public JTaskPaneGroup getTaskGroup() {
    ...
    public void showTask(String sTaskClass) {
        ...
        if (m_appuser.hasPermission(sTaskClass)) {
            ...
            if (m_jLastView == null || (m_jMyView != m_jLastView && m_jLastView.deactivate())) {    //  현재 선택한 뷰를 보여줘야 할 때

                // Construct the new view
                if (m_jMyView == null) {    //  선택한 뷰를 보여준 적이 없을 때, 새로 뷰를 만들어주고 기록이 있을 시 그냥 activate한다
                    ...
                    m_jPanelContainer.add(m_jMyView.getComponent(), sTaskClass);    //  메인 화면에 m_jMyView를 띄워준다
